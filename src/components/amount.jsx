...
export function Amount() {
    ...
    return (
        <div className="col-start-2 col-end-3 row-start-1 row-end-2 h-max p-3 flex  justify-center items-center gap-2 w-full">
            <div className="p-8 border rounded-md md:h-auto min-h-44 w-full bg-slate-900">
            ...
            <div className={`p-8 border rounded-md md:h-auto min-h-44 w-full  ${receita - despesa < 0 ? "bg-red-400" : "bg-green-400"}`}>
